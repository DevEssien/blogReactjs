...
class Feed extends Component {
    ...
    componentDidMount() {
        ...
        fetch("http://localhost:8080/graphql", {
            ...
            .then((resData) => {
                ...
                console.log("res status", resData.data.user.status);
    ...
    statusUpdateHandler = (event) => {
        console.log("entered the update handler");
    ...
    finishEditHandler = (postData) => {
        ...
        fetch("http://localhost:8080/post-image", {
            ...
            .then((fileResData) => {
                ...
                let graphqlQuery = {
                    query: `
                        mutation createNewPost($postTitle: String!, $postContent: String!, $postImageUrl: String!){
                            createPost(postInput: { title: $postTitle, content: $postContent, imageUrl: $postImageUrl}) {
                                _id
                                title
                                content
                                imageUrl
            ...
            .then((resData) => {
                if (resData.errors && resData.errors[0].status === 422) {
                    throw new Error(
                        "Validation failed, please check if email already used",
                    );
                }
                if (resData.errors) {
